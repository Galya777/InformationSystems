...
WaterDinos::WaterDinos(std::string name, std::string sex, std::string category)
{
	this->name = name;
...
void WaterDinos::read_from_file(std::ifstream& stream)
{

}

void WaterDinos::print(const char* filename)
{
